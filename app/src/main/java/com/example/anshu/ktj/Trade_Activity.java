                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem != null) {
                            ...
                            if (drawerItem.getIdentifier() == 1) {
                                intent = new Intent(Trade_Activity.this, Home_Activity.class);
                            } else if (drawerItem.getIdentifier() == 2) {
                                intent = new Intent(Trade_Activity.this, LiveMarket_Activity.class);
                            } else if (drawerItem.getIdentifier() == 3) {
                                intent = new Intent(Trade_Activity.this, Wallet_Activity.class);
                            } else if (drawerItem.getIdentifier() == 4) {
                                intent = new Intent(Trade_Activity.this, Trade_Activity.class);
                            } else if (drawerItem.getIdentifier() == 5) {
                                intent = new Intent(Trade_Activity.this, Trans_Activity.class);
                            }
                            if (intent != null) {
